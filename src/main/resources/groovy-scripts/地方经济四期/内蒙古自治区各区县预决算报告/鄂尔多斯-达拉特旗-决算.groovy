...
/**
 * 地方经济四期-内蒙古自治区各区县预决算报告-鄂尔多斯-达拉特旗-决算
 *


 * 起始请求链接: https://czt.nmg.gov.cn/yjs/business/basic/select?id=150621zf&type=3&p=1
 * 起始请求方式: GET
 */
class EEDS_DLTQ_JS implements IparseScript {
    ...
    ParsePageResult doParse(ParsePageRequest request) {
        ...
        if (parser == null) {
            ...
            for (Map<String, Object> node : nodes) {
                ...
                pageParams.put("webUrl", "http://czt.nmg.gov.cn/yjs/business/page/list?type=3&basicId=150621zf")
        ...
        if (parser == "详情页") {
            ...
            String pageTitle = "地方经济四期\\内蒙古自治区各区县预决算报告\\鄂尔多斯\\达拉特旗\\决算"
        ...
        if (parser == "文件详情页") {
            ...
            for (Map<String, Object> node : nodes) {
                ...
                addDataMap(pageResult, dataMap, Pair.of("statistic_area", "统计区域"), "内蒙古自治区鄂尔多斯市达拉特旗", true)
