...
/**
 * 地方经济四期-内蒙古自治区各区县预决算报告-呼和浩特-和林格尔县-决算
 *


 * 起始请求链接: https://czt.nmg.gov.cn/yjs/business/basic/select?id=150123zf&type=3&p=1
 * 起始请求方式: GET
 */
class HHHT_HLGEX_JS implements IparseScript {
    ...
    ParsePageResult doParse(ParsePageRequest request) {
        ...
        if (parser == null) {
            ...
            for (Map<String, Object> node : nodes) {
                ...
                pageParams.put("webUrl", "http://czt.nmg.gov.cn/yjs/business/page/list?type=3&basicId=150123zf")
        ...
        if (parser == "详情页") {
            ...
            String pageTitle = "地方经济四期\\内蒙古自治区各区县预决算报告\\呼和浩特\\和林格尔县\\决算"
