 ...
 * 起始请求链接: https://czt.nmg.gov.cn/yjs/business/basic/select?id=150627zf&type=2&p=1
 * 起始请求方式: GET
 */
class EEDS_YJHLQ_YS implements IparseScript {
    ...
    ParsePageResult doParse(ParsePageRequest request) {
        ...
        if (parser == null) {
            ...
            for (Map<String, Object> node : nodes) {
                ...
                pageParams.put("webUrl", "http://czt.nmg.gov.cn/yjs/business/page/list?type=2&basicId=150627zf")
        ...
        if (parser == "详情页") {
            ...
            String pageTitle = "地方经济四期\\内蒙古自治区各区县预决算报告\\鄂尔多斯\\伊金霍洛旗\\预算"
