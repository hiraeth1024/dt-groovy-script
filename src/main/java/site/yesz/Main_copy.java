...
@Slf4j
@Getter
public class Main_copy implements PageProcessor {
    ...
    private String groovyFileName = "地方经济四期/内蒙古自治区各区县预决算报告/鄂尔多斯-伊金霍洛旗-j算.groovy";
//    String startUrl = "https://www.baidu.com/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Main_copy groovyTestProcessor = new Main_copy();
